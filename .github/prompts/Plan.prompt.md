...
Exact build/test command (including `-c Release` and a framework-appropriate test filter expression where applicable). State the expected outcome: exit code, passing test count, or specific observable state.
