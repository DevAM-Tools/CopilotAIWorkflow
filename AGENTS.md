...
| Workflow stages (`/plan`, `/implement`, `/review`, `/review-loop`, `/complex-task`) | [`.github/skills/workflow-*.md`](.github/skills/) |
...
| Slash commands | [`.cursor/commands/`](.cursor/commands/) | `/plan`, `/implement`, `/review`, `/review-loop`, `/complex-task` |
