...
public sealed class LineLengthAnalyzerTests
{
    ...
    [Test]
    public async Task LineLength_Over160_ReportsCsv001()
    {
    ...
    [Test]
    public async Task LineLength_CustomMaxLength_ReportsCsv001()
    {
        const string source = """
            class C { int value = 1; }
            """;
        ...
        const string editorConfig = """
            [*.cs]
            build_property.csv_max_line_length = 10
            """;
    ...
    public async Task LineLength_InvalidMaxLength_UsesDefault160()
    {
        ...
        const string editorConfig = """
            [*.cs]
            build_property.csv_max_line_length = not-a-number
            """;
