...
public sealed class NoVarAnalyzerTests
{
    ...
    [Test]
    public async Task NoVar_LocalDeclaration_ReportsCsv002()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task NoVar_ForeachVar_ReportsCsv002()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task NoVar_DeconstructionVar_ReportsCsv002()
    {
        const string source = Usings + """
            namespace N;
            class C
