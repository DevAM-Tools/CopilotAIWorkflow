...
public sealed class PrivateNamingAnalyzerTests
{
    ...
    [Test]
    public async Task PrivateNaming_InvalidField_ReportsCsc003()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task PrivateNaming_InvalidMethod_ReportsCsc003()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task PrivateNaming_InvalidProperty_ReportsCsc003()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task PrivateNaming_FieldInsidePublicNestedType_ReportsCsc003()
    {
        const string source = Usings + """
            namespace N;
            public sealed class C
