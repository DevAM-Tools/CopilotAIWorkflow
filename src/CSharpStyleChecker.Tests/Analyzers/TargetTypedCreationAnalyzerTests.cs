...
public sealed class TargetTypedCreationAnalyzerTests
{
    ...
    [Test]
    public async Task TargetTypedCreation_ExplicitParameterlessType_ReportsCsc008()
    {
    ...
    [Test]
    public async Task TargetTypedCreation_EmptyObjectInitializer_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public sealed class TypeA
    ...
    [Test]
    public async Task TargetTypedCreation_ExplicitEmptyList_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
    ...
    [Test]
    public async Task TargetTypedCreation_CollectionInitializer_InterfaceTarget_NoDiagnostic()
    {
        const string source = Usings + """
            namespace N;
            public static class C
    ...
    [Test]
    public async Task TargetTypedCreation_CollectionInitializer_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public static class C
    ...
    [Test]
    public async Task TargetTypedCreation_ArrayInitializer_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public static class C
    ...
    [Test]
    public async Task TargetTypedCreation_ExplicitTypeInReturn_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public sealed class TypeA
    ...
    [Test]
    public async Task TargetTypedCreation_ExplicitTypeInAssignment_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public sealed class TypeA
    ...
    [Test]
    public async Task TargetTypedCreation_ExplicitTypeInArgument_ReportsCsc008()
    {
        const string source = Usings + """
            namespace N;
            public sealed class TypeA
