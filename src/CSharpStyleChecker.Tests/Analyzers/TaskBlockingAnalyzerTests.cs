...
public sealed class TaskBlockingAnalyzerTests
{
    ...
    [Test]
    public async Task TaskBlocking_Wait_ReportsCsc004()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task TaskBlocking_Result_ReportsCsc004()
    {
        const string source = Usings + """
            namespace N;
            public class C
    ...
    [Test]
    public async Task TaskBlocking_WaitOnTaskField_ReportsCsc004()
    {
        const string source = Usings + """
            namespace N;
            public class C
