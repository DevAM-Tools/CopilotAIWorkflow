...
/// <summary>Tests for <see cref="CoverageGapReportBuilder"/> and <see cref="CoverageGapReportFormatter"/>.</summary>
public sealed class CoverageGapReportBuilderTests
{
    [Test]
    ...
    public async Task ToAgentJson_ContainsExitGapsBeforeBranchGaps()
    {
        CoverageGapReport report = new CoverageGapReport(
            new CoverageGapSummary(1d, 1, 1, 2, false, false),
    ...
    {
        CoverageGapReport report = new CoverageGapReport(
            new CoverageGapSummary(0.5d, 0, 1, 1, true, false),
            [],
            [new BranchGap(2, "Sample", "Foo", "b.cs", 2, 0, 0.5d, 1, "M", null)]);
