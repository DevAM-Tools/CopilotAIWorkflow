...
public sealed class VolatileFieldAccessAnalyzer : DiagnosticAnalyzer
{
    ...
    {
        ExpressionSyntax target = context.Node switch
        {
            AssignmentExpressionSyntax assignment => assignment.Left,
            PrefixUnaryExpressionSyntax prefixUnary => prefixUnary.Operand,
        ...
        if (!TryGetVolatileField(target, context.SemanticModel, out IFieldSymbol field))
        {
            return;
        }
