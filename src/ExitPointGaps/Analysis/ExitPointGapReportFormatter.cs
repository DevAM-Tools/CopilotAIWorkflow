...
/// <summary>Formats exit-point gap reports for agents and humans. 
/// Thread-safe; all members are stateless.
/// </summary>
public static class ExitPointGapReportFormatter
{
    ...
    /// <param name="report">Exit-point gap report.</param>
    /// <returns>JSON text.</returns>
    public static string ToAgentJson(Models.ExitPointGapReport report)
    {
    ...
    public static string ToCompact(Models.ExitPointGapReport report)
    {
        ArgumentNullException.ThrowIfNull(report);
    ...
    public static string ToText(Models.ExitPointGapReport report)
    {
        ArgumentNullException.ThrowIfNull(report);
